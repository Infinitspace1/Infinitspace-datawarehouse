...
LOCATION_SCRAPER_ENUM_ATTEMPTS=3           # LoopNet gb/ca enumeration retries before the broad-search fallback
...
LOOPNET_MAX_UNBLOCKER_REQUESTS=2000 # per-run paid-unblocker budget; a dense city can exhaust the default and get truncated

...
def transform_employee(raw: dict, bronze_id: int, sync_run_id: str) -> dict:
    return {
        ...
        "personal_email":     _str(raw.get("homeEmail")),
        ...
        "employment_status":  _str(raw.get("employmentHistoryStatus")),
        "hire_date":          _date(raw.get("hireDate")),
        "termination_date":   _date(raw.get("terminationDate")),
        "work_phone":         _str(raw.get("workPhone")),
        "work_phone_ext":     _str(raw.get("workPhoneExtension")),
        "mobile_phone":       _str(raw.get("mobilePhone")),
        "cost_center":        _str(raw.get("costCenter")),
        "pay_group":          _str(raw.get("payGroup")),
        "flsa_code":          _str(raw.get("flsaCode")),
        "gender":             _str(raw.get("gender")),
        "nationality":        _str(raw.get("nationality")),
        "marital_status":     _str(raw.get("maritalStatus")),
        "date_of_birth":      _date(raw.get("dateOfBirth")),
        "address1":           _str(raw.get("address1")),
        "city":               _str(raw.get("city")),
        "state":              _str(raw.get("state")),
        "country":            _str(raw.get("country")),
        "zip_code":           _str(raw.get("zipCode")),
        "photo_url":          _str(raw.get("photoUrl")),
        "bronze_id":          bronze_id,

...
_MERGE_SQL = """
    ...
    WHEN MATCHED THEN UPDATE SET
        ...
        payment_state = ?, invoice_ever_collected = ?,
...
class SilverCoworkerInvoicesWriter:
    ...
    def run(self) -> dict[str, int]:
        ...
        for row in rows:
            ...
            try:
                ...
                if is_excluded_location_source_id(invoice["location_source_id"]):
                    continue
    ...
    def _make_params(self, invoice: dict) -> tuple:
        vals = (
            ...
            invoice.get("payment_state"), invoice.get("invoice_ever_collected"),
